...
export const COUNTRY_RANKINGS: CountryAIScore[] = [
  ...
  { country: "Israel", countryCode: "IL", overall: 60, dimensions: { talent: 65, research: 58, development: 68, government: 62, commercial: 65, infrastructure: 58 }, highlights: "Dense startup ecosystem and defence AI applications" },
