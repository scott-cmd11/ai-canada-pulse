...
export const AI_EVENTS: AIEvent[] = [
  ...
  {
    id: "atlantic-canada-ai-summit",
    name: "Atlantic Canada AI Summit",
    date: "2026-05-15",
    endDate: "2026-05-16",
    city: "Halifax",
    province: "Nova Scotia",
    provinceSlug: "nova-scotia",
    type: "Summit",
    organizer: "Saint Mary's University / Atlantic Universities",
    url: "https://www.smu.ca/ai-summit/index.html",
    description: "Annual summit bringing together AI researchers, policymakers, and industry from across Atlantic Canada's universities including Dalhousie, SMU, Acadia, UNB, MUN, and UPEI.",
