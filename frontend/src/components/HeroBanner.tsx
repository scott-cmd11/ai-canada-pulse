            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
                ...
                <div className="max-w-2xl">
                    ...
                    <p className="text-base sm:text-lg text-indigo-200/80 leading-relaxed max-w-xl">
                        Real-time intelligence on Canada&apos;s AI ecosystem — tracking policy, economic indicators, market sentiment, research output, and compute infrastructure across the country.
                    </p>
