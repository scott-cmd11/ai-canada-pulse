...
const regionalEcosystems: TopicContent = {
    ...
    explainerParagraphs: [
        ...
        "Toronto is the commercial centre. The Vector Institute is now headquartered at the Schwartz Reisman Innovation Campus adjacent to the University of Toronto, and the surrounding Financial District concentrates AI teams at the Big Five banks and most publicly-traded Canadian tech employers. Shopify — headquartered in Ottawa but with a substantial Toronto footprint — also contributes to the corridor's AI engineering headcount. Toronto leads the country in enterprise AI deployment, venture funding, and raw headcount. Its weakness is that it pulls talent from across Canada into a single expensive metro.",
        "Montreal is the research centre. Mila, Université de Montréal, McGill, and HEC anchor a deep-learning research cluster that is competitive with any in the world. The city also hosts a distinctive entertainment-AI cluster — Ubisoft and Unity — alongside commercial AI operations including Cohere's Montreal office, Borealis AI, Coveo, and the Samsung AI Center Montreal. French-language talent flow from European francophone countries is a structural advantage.",
        "Edmonton — with Calgary as an increasingly important secondary node — anchors the Prairie AI ecosystem around Amii and the University of Alberta. The Edmonton-Calgary corridor remains the centre of gravity for Canadian reinforcement learning research and has a distinctive applied-AI scene aligned with energy, agriculture, and public-sector sponsors. Alberta's aggressive data-centre incentives and cheap power are shifting the infrastructure side of the Prairie story.",
    ...
    keyPeople: [
        { name: "Richard Sutton", role: "Chief Scientific Advisor", org: "Amii — anchor of Edmonton's RL ecosystem" },
        { name: "Yoshua Bengio", role: "Founder and Scientific Advisor", org: "Mila — anchor of Montreal's research ecosystem" },
        { name: "Aidan Gomez", role: "Co-founder and CEO", org: "Cohere — anchor of Toronto's commercial AI cluster" },
    ],
    keyOrgs: [
