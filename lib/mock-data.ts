...
export const MOCK_FEED_ITEMS: FeedItem[] = [
    {
        ...
        description: "The Government of Canada has unveiled a $2.4 billion investment to build a sovereign AI cloud infrastructure, aimed at keeping sensitive data within Canadian borders.",
    ...
    },
    {
        ...
        description: "Toronto-based Cohere launches the next generation of its enterprise LLM with improved retrieval-augmented generation and support for 23 languages.",
    ...
    },
    {
        ...
        description: "A team at Mila has published a paper proposing a new neural architecture that dynamically adjusts its parameters, promising more efficient inference.",
    ...
    },
    {
        ...
        description: "Parliamentary hearings on the Artificial Intelligence and Data Act resume this week with Privacy Commissioner testimony scheduled.",
    ...
    },
    {
        ...
        description: "Vector Institute announces a new partnership with five Ontario hospitals to build predictive AI models for patient outcomes.",
    ...
    },
    {
        ...
        description: "The Biden administration signs a new executive order establishing mandatory AI safety testing requirements for frontier models.",
    ...
    },
    {
        ...
        description: "The European Union's landmark AI regulation moves toward final implementation, with compliance deadlines set for 2025.",
    ...
    },
    {
        ...
        description: "Britain's AI Safety Institute announces a global partnership network with ten countries to coordinate frontier AI testing.",
    ...
    },
    {
        ...
        description: "Japan's national research institute RIKEN announces a new foundation model trained on the Fugaku supercomputer.",
    ...
    },
    {
        ...
        description: "India's Ministry of Electronics commits $1.25 billion to expanding the national AI mission with new compute infrastructure.",
    ...
    },
    {
        ...
        description: "Australia's national science agency CSIRO teams up with Google DeepMind to develop a responsible AI governance framework.",
    ...
    },
    {
        ...
        description: "Singapore's IMDA releases updated governance guidelines specifically addressing generative AI risks and deployment standards.",
